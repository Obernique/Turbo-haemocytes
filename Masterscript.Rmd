...
# Plot
ggplot(lysosensor_plot, aes(x = Sample, y = Average)) +
  ...
  geom_errorbar(aes(ymin = Average - Standard_Deviation, ymax = Average + Standard_Deviation),
                width = 0.2, position = position_dodge(0.9)) +
  labs(title = "Lysosomal activity of different haemocyte types",
       x = "Haemocyte type",
       y = "Lysosomal activity (AU)") +
  theme_bw() +
   scale_x_discrete(labels = c("Granulocytes", "Hyalinocytes 1", "Hyalinocytes 2"))
...
# Plot
ggplot(mitotracker_plot, aes(x = Sample, y = Average)) +
  geom_bar(stat = "identity", position = "dodge", fill = "grey", color = "black") +
  geom_errorbar(aes(ymin = Average - Standard_Deviation, ymax = Average + Standard_Deviation),
                width = 0.2, position = position_dodge(0.9)) +
  labs(title = "Mitochondrial activity of different haemocyte types",
       x = "Haemocyte type",
       y = "Mitochondrial activity (AU)") +
  theme_bw() +
   scale_x_discrete(labels = c("Granulocytes", "Hyalinocytes 1", "Hyalinocytes 2"))
